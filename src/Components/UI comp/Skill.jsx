...
import {   SiReact,   SiTailwindcss,   SiNodedotjs,    SiMongodb,   SiGit,   SiGithub, SiVercel, SiFigma,   SiPostman
} from "react-icons/si";
...
export const Skill = () => {
    ...
    return (
        <div className="container my-5 overflow-hidden">
            ...
            <div className="row gy-5 skill-row my-5 py-5  ">
                <motion.div
                    ...
                    <ul className="row list-unstyled h-100 mb-0 px-2 " >
                        {
                            topic.map((curt) => {
                                ...
                                return <Topics key={curt.id} curt={curt} handleShowContent={handleShowContent} />
                            })
                        }
                    </ul>
                </motion.div>
